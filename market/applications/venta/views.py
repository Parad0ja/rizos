...
class ClienteRegisterForm(FormView):
    template_name = 'venta/nuevocliente.html'
    form_class = ClienteRegisterForm
    success_url = reverse_lazy('venta_app:cliente-lista')

    def form_valid(self, form):
        #
        Cliente.objects.create_cliente(
            form.cleaned_data['P_nombre'],
            form.cleaned_data['P_apellido'],
        ...
        # 
        return super(ClienteRegisterForm, self).form_valid(form)


class ClienteListView(ListView):
    model = Cliente
    paginate_by = 4
    template_name = "venta/clientes.html"

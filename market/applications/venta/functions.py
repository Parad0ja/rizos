...
# #este proceso me hace la suma al inventario
# def procesar_compra(self, **params_venta):
#     # recupera la lista de productos en carrtio
#     productos_en_car = CarShop.objects.all()
#     if productos_en_car.count() > 0:
        
#         # crea el objeto venta entonces aqui debo crear el objeto compra y hacer referencia al modelo compra
#         venta = Sale.objects.create(
#             date_sale=timezone.now(),
#             count=0,
#             amount=0,

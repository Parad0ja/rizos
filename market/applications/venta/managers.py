...
#este el el create cliente que para la auditoria, que pise del succes de la vista
class ClienteManager(BaseUserManager, models.Manager):
    ...
    def create_cliente(self, P_nombre, P_apellido, **extra_fields):
        return self._create_cliente(P_nombre, P_apellido, **extra_fields)


    def clientes_sistema(self):
        return self.filter(
            is_superuser=False
        ).order_by('-last_login')        